		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					...
					<p id="defaultBalance" hidden><?php echo $data['balance'];?></p>
				</div>
		 
				<form class="form-horizontal" action="user_data_edit_table.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="balance" type="number" placeholder="" min="0" step="1" value="<?php echo $data['balance'];?>" required>
						</div>
					</div>
